namespace JayTools.JayRandoms
{
    ...
    public class Perlin
    {
        ...
        private static readonly int[] permutation =
        {
            ...
            21, 10, 23, // arranged array of all numbers from 0-255 inclusive.
        ...
        public double GetPerlin(double x, double y, double z)
        {
            ...
            int
                xi = (int) x &
                     255; // Calculate the "unit cube" that the point asked will be located in
            int
                yi = (int) y &
                     255; // The left bound is ( |_x_|,|_y_|,|_z_| ) and the right bound is that
            int
                zi = (int) z &
                     255; // plus 1.  Next we calculate the location (from 0.0 to 1.0) in that cube.
