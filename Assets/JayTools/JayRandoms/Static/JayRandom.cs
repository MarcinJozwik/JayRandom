...
namespace JayTools.JayRandoms.Static
{
    ...
    public static class JayRandom
    {
        ...
        /// <returns></returns>
        public static float PerlinNoise(float x, float y, float z, int repeat = -1)
        {
            return RandomService.PerlinNoise(x, y, z, repeat);
        }
        ...
        /// <param name="repeat">Make input coordinates overflow if they are over the repeat variable.</param>
        /// <returns></returns>
        public static float OctavePerlinNoise(float x, float y, float z, int octaves, float persistence, int repeat = -1)
        {
            return RandomService.OctavePerlinNoise(x, y, z, octaves, persistence, repeat);
        }
